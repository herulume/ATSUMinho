...
public class Menu{
    ...
    private void pickChildMenus() {
        ...
        switch (this.menu) {
            case Initial:
                printMenuOptions(MenuInd.Login, MenuInd.Register);
                break;
            case Register:
                printMenuOptions(MenuInd.RegisterClient, MenuInd.RegisterOwner);
                break;
            case Client:
                printMenuOptions(MenuInd.HistoryClient, MenuInd.Pending, MenuInd.Rentals, MenuInd.Top10Clients);
                break;
            case Top10Clients:
                printMenuOptions(MenuInd.NUses, MenuInd.Distance);
                break;
            case Rentals:
                printMenuOptions(MenuInd.Closest, MenuInd.Cheapest, MenuInd.CheapestNear, MenuInd.Specific, MenuInd.Autonomy);
                break;
            case Owner:
                printMenuOptions(MenuInd.HistoryOwner, MenuInd.CarOverview, MenuInd.ReviewRental, MenuInd.AddCar);
                break;
        }
    }

    private void printMenuOptions(MenuInd... options) {
        if (options.length > 0){
