...
public class UmCarroJaApp {
    ...
    public static void calcFactBDates() {
        ...
        str.append("O total facturado pelo veículo de matrícula ");
        str.append(matricula);
        str.append(" faturou no total: ");
        str.append(total);
        str.append(" euros, entre ");
        str.append(inicio.toString());
        str.append(" e ");
        str.append(fim.toString());
        str.append(".\n");
        out.println(str);
    }
    ...
    private static List<Aluguer> filterAlugueresBD(List<Aluguer> alugs, GregorianCalendar dataInicio, GregorianCalendar dataFim) {
        ...
        for (Aluguer alug : alugs) {
            if (alug.getDataInicio().after(dataInicio) && alug.getDataFim().before(dataFim) && alug.getRealizado() == true) {
                res.add(alug);
            }
        }
