...
public class Utilizador implements Serializable {
    ...
    public String toString() {
        ...
        str.append(this.dataNascimento.get(GregorianCalendar.DAY_OF_MONTH));
        str.append("/");
        str.append(this.dataNascimento.get(GregorianCalendar.MONTH) + 1);
        str.append("/");
        str.append(this.dataNascimento.get(GregorianCalendar.YEAR));
        str.append("\n");
