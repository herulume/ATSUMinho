...
public class Veiculo implements Serializable, Classificação {
    ...
    public Veiculo(String marca, String matricula, String nif, int velocidade, double preco, double consumo,
        ...
        ArrayList<ParDatas> parDatas = new ArrayList<>();
        for (ParDatas datasAlug : datasAlugs) {
            ParDatas clone = datasAlug.clone();
            parDatas.add(clone);
        }
        this.datasAlugueres = parDatas;
    }
     ...
     */
    public List<ParDatas> getDatasAlugueres() {
        List<ParDatas> list = new ArrayList<>();
        for (ParDatas datasAluguere : this.datasAlugueres) {
            ParDatas clone = datasAluguere.clone();
            list.add(clone);
        }
        return list;
    }
     ...
     */
    public void setPosicao(Coordinate cords) {
        this.posicao = cords;
    }
     ...
     */
    public void setDatasAlugueres(List<ParDatas> datas) {
        List<ParDatas> list = new ArrayList<>();
        for (ParDatas data : datas) {
            ParDatas clone = data.clone();
            list.add(clone);
        }
        this.datasAlugueres = list;
    }
    ...
    public String toString() {
        ...
        str.append("\n");
        str.append("Matrícula: ");
        str.append(this.matricula);
        str.append("\n");
        str.append("NIF do Proprietário: ");
        str.append(this.nif);
        str.append("\n");
        str.append("Velocidade Média: ");
        str.append(this.velocidade);
        str.append("\n");
        str.append("Preço Base por Km: ");
        str.append(this.preco);
        str.append("\n");
        str.append("Consumo: ");
        str.append(this.consumo);
        str.append("\n");
        str.append("Autonomia: ");
        str.append(this.autonomia);
        str.append("\n");
        str.append("Posição (latitude e longitude): ");
        str.append(this.posicao.toString());
        str.append("\n");
        str.append("Disponível: ");
        str.append(this.disponivel);
        str.append("\n");
        str.append("Classificação: ");
        str.append(this.classificacao);
        str.append("\n");
