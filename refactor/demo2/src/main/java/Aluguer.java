...
public class Aluguer implements Serializable {
     ...
     */
    public int getTempoAteVeiculo() {
        return this.tempoAteVeiculo;
    }
     ...
     *             3 - classificação foi dada a ambos.
     */
    public int getEstadoClassificacao() {
        return this.estadoClassif;
    }
     ...
     */
    public void setCustoViagem(double newCost) {
        this.custoViagem = newCost;
    }
     ...
     */
    public void setRealizado(boolean done) {
        this.realizado = done;
    }
     ...
     * Altera o valor do campo listaEspera.
     */
    public void setAlteraPreco(boolean altPrc) {
        this.altPrice = altPrc;
    }
     ...
     */
    public void setEstadoClassificacao(int estado) {
        this.estadoClassif = estado;
    }
    ...
    public String toString() {
        ...
        str.append("*****    ALUGUER    *****\n");
        str.append("Mail do Cliente: ");
        str.append(this.mail);
        str.append("\n");
        str.append("Matrícula do Veículo: ");
        str.append(this.matricula);
        str.append("\n");
        str.append("Data de início do aluguer: ");
        str.append(this.dataInicio);
        str.append("\n");
        str.append("Data de fim do aluguer: ");
        str.append(this.dataFim);
        str.append("\n");
        str.append("Custo da Viagem: ");
        str.append(this.custoViagem);
        str.append("\n");
        str.append("Tempo a pé até ao veículo: ");
        str.append(this.tempoAteVeiculo);
        str.append("\n");
        str.append("Tempo total da viagem: ");
        str.append(this.tempoViagem);
        str.append("\n");
        str.append("Aluguer Aceite pelo Proprietário: ");
        str.append(this.aceite);
        str.append("\n");
        str.append("Aluguer em lista de espera: ");
        str.append(this.listaEspera);
        str.append("\n");
        str.append("Aluguer Realizado: ");
        str.append(this.realizado);
        str.append("\n");
        str.append("Preço modificado pelo proprietário do veículo: ");
        str.append(this.altPrice);
        str.append("\n");
        str.append("Estado da classificação: ");
        str.append(this.estadoClassif);
        str.append("\n");
