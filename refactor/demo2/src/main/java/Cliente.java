...
public class Cliente extends Utilizador implements Classificação {
     ...
     */
    public void setPosicao(Coordinate novaP) {
        this.posicao = novaP;
    }
     ...
     */
    public void setNAlugueres(int nAlug) {
        this.nAlugueres = nAlug;
    }
    ...
    public String toString() {
        ...
        str.append("Posição em que o cliente se encontra: ");
        str.append(this.posicao.toString());
        str.append("\n");
        str.append("Classificação do cliente: ");
        str.append(this.classificacao);
        str.append("\n");
        str.append("Número de alugueres efetuados: ");
        str.append(this.nAlugueres);
        str.append("\n");
        str.append("Número de Km percorridos: ");
        str.append(this.nKM);
        str.append("\n");
        return str.toString();
    }
